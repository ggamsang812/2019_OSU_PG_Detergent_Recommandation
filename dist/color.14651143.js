...
function picked(userchoice, index) {
  if (userchoice.style.background != 'rgb(246, 174, 45)') {
    userchoice.style.background = 'rgb(246, 174, 45)'; //push the index of the images clicked

    y.push(index);
  } else {
    userchoice.style.background = '#006FB6'; //pop the Index
...
},{}]},{},["../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","js/color.js"], null)
